...
class ChartSnapshot(gtk.DrawingArea):
    ...
    def dispatch(self,da,cr):
        ...
        # The browser starts with an empty selection.  PyGTK happened to
        # swallow the resulting draw error; PyGObject reports it repeatedly.
        if len(chart.houses) != 12 or len(chart.planets) < 11:
            return True
