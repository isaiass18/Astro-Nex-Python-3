...
class PlanetogramMixin(object):
    ...
    def __init__(self,zodiac):
        ...
        self.plagram_moon_f = self.plagram_plan[1]
        self.plagram_moon_b = self.plagram_plan.pop()
    ...
    def draw_planetogram(self,cr,width,height,chartob):
        ...
        drawer = getattr(getattr(boss, 'da', None), 'drawer', None)
        if drawer and drawer.get_showAP():
    ...
    def this_swap_fmoon(self):
        self.plagram_plan[1] = self.plagram_moon_f
        self.plextra[1] = self.plagram_moon_f
    
    def this_swap_bmoon(self):
        self.plagram_plan[1] = self.plagram_moon_b
        self.plextra[1] = self.plagram_moon_b
