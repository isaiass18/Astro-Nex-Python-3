...
class CoupleDates(DateEntry):
    def __init__(self,parent,boss):
        ...
        # GObject-backed widgets must be initialized before Python attributes
        # are assigned under PyGObject.
    ...
    def calc_and_set(self,entry):
        ...
        try:
            ...
            if iter:
                ...
                coup = self.parent_panel.coup_ix
                curr.couples[coup]['dates'][path] = (dtstring,desc)
                self.parent_panel.changes = True
        except AttributeError:
            pass
